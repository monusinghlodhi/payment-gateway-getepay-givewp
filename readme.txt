=== Payment Gateway GetePay GiveWP ===
Contributors: monusingh
Tags: Getepay payment gateway
Donate link: https://www.buymeacoffee.com/monusingh/
...
Currently GetePay only support Indian Rupees (INR).
	
==What if I have some other question related to GetePay?==
	
Please open a ticket by emailing to us, info@getepay.com.
